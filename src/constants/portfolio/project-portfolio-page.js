...
const engineeringProjects = [
  {
    ...
    description: `A sample holder designed for a 7 tesla Optical Cryostat with 
                  the capacity to measure up to 4 in-plane samples and 4 out-of-plane samples
                  concurrently.`, 
    experiences: [`Prioritized heat dissipation through the thermally anchored base and minimizing 
                   resistive heating from eddy-currents generated by the magnetic field`,
                  `Designed a flared base with slits in order to minimize resistive heating effects`,
                  `Designed PCBs with wirebonding pads which deliver low-frequency microwaves 
                   to the samples`,
                  `Repurposed existing co-planar waveguides to deliver high-frequency microwaves
                   to the samples`,
                  `Ensured all components are non-magnetic and can withstand ultra-low temperatures
                   and pressures`],
  ...
  },
  {
    ...
    experiences: [`Installed and configured proxmox to run several virtual windows machines with Solidworks, MATLab, LTSpice
                  ...
                  `Installed Docker on an ubuntu server VM with portainer to continously run python scripts for lab automation, 
                   and data processing`,
                  `Configured TruNAS community with software RAID 1 to serve as a data storage solution for the lab`,
...
},
{
    ...
    description: `A rendering of a diagram for a nano-device to be published in a academic paper. 2D circuit diagram
                  symbols have been drawn as abstract 3D representations of each component`,
    date: "Jan 2023"
},
{
...
},
{
    ...
    description: `A minimalist lamp which also serves as a nightlight. The LEDs in the acrylic base can be switched on 
                  and off indepently from the main light. `,
...
const softwareProjects = [
    ...
    description: `Learned React.JS, Tailwind, and other technologies by following several
                  different tutorials.`,
    link:"https://github.com/CRXKXWYI49/Learning-Web-Development",
    },
    {
